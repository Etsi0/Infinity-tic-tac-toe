 ...
 */
export function WinConPrep(piece: keyof typeof history): boolean {
 ...
 */
function IsMatchingPiece(piece: keyof typeof history, coordinate: coords): boolean {
